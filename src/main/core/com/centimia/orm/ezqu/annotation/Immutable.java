 ...
 * Sometimes this creates issues and ezQu will throw an exception stating it found two instances of the same entity in the session. 
 ...
 * annotation should be put on such entites to tell ezQu just that and allow multi instances</li>
