...
public class Function implements Token {
    ...
    public static <X, A> A byPrimaryKey(A obj, X key, Db db) {
    	...
    	return db.registerToken(o, (s, q) -> q.appendSQL(s, key, key.getClass().isEnum(), key.getClass()));
    }
	...
	private static <X> X handleEnum(X x, Class<X> clazz) {
		...
		if (null == o)
			throw new EzquError("Doing an aggragate function on an enum type with a single value makes no sense");
		return o;
	}
}