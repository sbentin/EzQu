...
public class EzquConcurrencyException extends EzquError {
	...
	public EzquConcurrencyException(String tableName, Class<?> class1, Object primaryKey, Number version) {
		super("Concurrency error on table: %s of %s with primaryKey %s. Looking for version %s but was different",
