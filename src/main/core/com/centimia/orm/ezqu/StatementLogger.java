...
import com.centimia.orm.ezqu.util.Logger;
import com.centimia.orm.ezqu.util.SimpleLogger;
import com.centimia.orm.ezqu.util.Slf4jLogger;
...
public class StatementLogger {
    ...
    public static void printStats() {
    	if (isGathering){
    		...
    		logger.info("Statistics were not gathered. To gather statistics please turn on showSQL on EzquFactory!!");
    }
