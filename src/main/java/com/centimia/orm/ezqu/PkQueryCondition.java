...
public class PkQueryCondition<T, A> extends QueryCondition<T, A> {
	...
	public QueryWhere<T> like(A pattern, LikeMode mode) {
        throw new EzquError("'Like' not supported for Pk conditions!!!");
    }

    @Override
	public QueryWhere<T> isNotNull() {
    	throw new EzquError("'isNotNull' not supported for Pk conditions!!!");
    }

    @Override
	public QueryWhere<T> isNull() {
    	throw new EzquError("'isNull' not supported for Pk conditions!!!");
    }

    @Override
	public QueryBetween<T, A> between(A y){
    	throw new EzquError("'between' not supported for Pk conditions!!!");
    }
}